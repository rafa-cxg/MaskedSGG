...
class SggpFinetune(SggpBase):
    ...
    def __init__(
        ...
        self.map_bert2predicate_idx = vocab_match_predicate(self.tokenizer.vocab,self.predicate_to_idx)
        torch.save(self.map_bert2predicate_idx, 'map_bert2predicate_idx.pth')
    ...
    def forward(self, samples, is_train=True):
        ...
        if self.task_mode == "sgdet":
            ...
            for instance_gt in instance_gts:
                instance_gt.set('rel_pair_idxs',instance_gt.get('relation_tuple')[:,:2])
